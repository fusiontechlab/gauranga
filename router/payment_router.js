      ...
      placedorder.items.forEach(element => {
        ...
        .then((soldpro)=>{
           ...
           let rt = soldpro.find(o=>{
            ...
            .then((solditem)=>{
             ...
             Axios.get(`http://sms.fusiontechlab.com/app/smsapi/index.php?key=5ffc399da3287&type=text&contacts=${req.user.phone}&senderid=GPAULS&msg= your order is placed`).then(result=>{
        ...
        .catch(err=>{
          ...
          res.redirect('/orderList');
            ...
            // Axios.get(`http://sms.fusiontechlab.com/app/smsapi/index.php?key=5ffc399da3287&type=text&contacts=${req.user.phone}&senderid=GPAULS&msg= your order is placed through your credit cart 123XXXXXXXX78`).then(result=>{
            //     console.log(result.data);
            // })
